...
import { SaveSecurityLog } from '../../../../api/projectmanage/ProjectManageRequests'
const StyleSheet = require('../../../../base/StyleSheet');
const ds = new ListView.DataSource({ rowHasChanged: (r1, r2) => r1 !== r2 });
let pics = [];
let inputContent = '';
let navigateTitle = '新建安全日志';
let navigatePlaceholder = '请输入安全日志';
class NewSafeScene extends Component {
        ...
        self.dialogbox.confirm({
            ...
            ok: {
                ...
                callback: () => {
                    ...
                    let params = { sendUserName: _USERNAME_, projectId: this.id,content: inputContent, file: pics};
                    new SaveSecurityLog(params).start(function (data) {
                        self.setState({
                            isShowHud: false,
                        });
                        Toast.show('新建安全日志成功', {
                        ...
                        DeviceEventEmitter.emit('NEWSAFE_SUCCESS', null);
                        self.props.navigation.goBack();
                    }, function (error) {
                        self.setState({
                            isShowHud: false,
                        });
                        Toast.show('新建安全日志失败，请稍后重试', {
                            duration: Toast.durations.LONG,
                            position: -100
                        });
                    })
