        ...
        return (
            <View style={styles.container}>
                ...
                <AuditDetailHeader
                    ...
                    id={this.processId}
                />
                <ScrollableTabView style={{marginBottom: autoMarginBottom}}
                                   ...
                                   />}>
                    <FlowScene
                        tabLabel="项目流程" navigation={this.props.navigation}
                        processId={ this.processId}/>
                    <DetailScene tabLabel="基本信息" navigation={this.props.navigation}
                                 processId={ this.processId}/>
                    <FlowFileScene tabLabel="项目资料" navigation={this.props.navigation}
                                   processId={ this.processId}/>
                    {this.projectStage !== 0 &&
...
export default AuditProcessScene;