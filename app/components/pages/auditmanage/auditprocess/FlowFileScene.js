...
import {GetApprovalInformationListRequest} from '../../../../api/auditmanage/AuditManageRequests'
...
export default class FlowFileScene extends Component {
    constructor(props) {
        super(props);
        this.state = {
            clickImageUri: '',
    ...
    _onRefresh() {
        ...
        let params = {projectId: self.props.processId};
        new GetApprovalInformationListRequest(params).start(function (data) {
            self.setState({
                    ...
                    <View style={styles.itemSubContainer}>
                        ...
                        <View style={styles.itemSubTextContainer}>
                            ...
                            <Text adjustsFontSizeToFit={false} allowFontScaling={false}
                                ...
                                {getFileSize(item.fileSize) + ' ' + !isNull(item.createTime) ? item.createTime.split(' ')[0] : item.createTime
                                    + ' ' + item.createUser}
                            </Text>
                        </View>
                    </View>
