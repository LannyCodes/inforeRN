...
export default class ApprovalRecordScene extends Component {
    constructor(props) {
        super(props);
                                ...
                                <View key={j}>
                                    <View style={styles.itemFileInfo}>
                                        <Image
                                            resizeMode='contain'
                                            style={styles.headIcon}
                                            source={subItem.fileType && (item.fileType === '.png' || item.fileType === '.jpg' || item.fileType === '.jpeg' ) ? {uri: subItem.fileHeaderImg} : FILE_IMG_ICON[subItem.fileType]}
                                        />
                                        <Text adjustsFontSizeToFit={false} allowFontScaling={false}
